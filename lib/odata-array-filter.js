/*
* odata-array-filter - https://github.com/kaseya/odata-array-filter
*
...
ODataArrayFilter = (function() {
  ...
  function _getValueAtObjectPath(path, obj) {
    var val = obj;
    ...
    switch (filter.type) {
      ...
      case 'ge':
        ...
        return arr.filter(function(obj) {
          var propVal = _getValueAtObjectPath(prop, obj);
          propVal = _getFieldValue(filter.left, propVal);
